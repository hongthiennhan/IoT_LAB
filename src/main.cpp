...
// HCMUT-LTK
float long_HCMUT_LTK = 106.65789107082472;
float lat_HCMUT_LTK = 10.772175109674038;

// HCMUT-H6
float long_HCMUT_H6 = 106.80633605864662;
float lat_HCMUT_H6 = 10.880018410410052;
